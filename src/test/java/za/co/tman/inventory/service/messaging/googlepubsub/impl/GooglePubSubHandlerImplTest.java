package za.co.tman.inventory.service.messaging.googlepubsub.impl;
...
import za.co.tman.inventory.config.PubSubMessagingProperties;
import za.co.tman.inventory.enums.PubSubMessageType;
import za.co.tman.inventory.service.messaging.IMMessageProcessor;
import za.co.tman.inventory.service.messaging.googlepubsub.GooglePubSubHandler;
...
public class GooglePubSubHandlerImplTest {
    ...
    public void getSubscriptions() {
        ...
        List<String> targetSubscriptionNamesList = Arrays.asList("IntegrationTopicSub", "IntegrationGenericSub");
